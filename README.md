...
###  O projeto consiste em desenvolver uma calculadora utilizando as principais stacks:
🎯 HTML
🎯 CSS 
🎯 Javascript
...
- Possui um histórico exibido ao lado direito da calculadora, onde vai ```salvar``` , ```deletar``` e clicar na ```operação retornando ao visor```;
...
<img src= "https://media.giphy.com/media/3zSF3Gnr7cxMbi6WoP/giphy.gif" align="center" height="55" width="55"> [Vídeo/Calculadora]<img src= "https://media.giphy.com/media/E5DzZsofmgxc9wjbhX/giphy.gif" align="center" height="35" width="35">

<img height="480em" src="video/calc_labs.mp4"  align="center">
